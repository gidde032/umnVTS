...
Unless specified, AI Usage Level 0 - No AI Allowed

Some AI-assistance permitted, but not required, for documentation tasks, see specific task for details.

* Tasks 1-3: AI Usage Level 2
* Tasks 4-7: AI Usage Level 0 
...
|-----------------|-----|-----------------|
| 11/21/2025 at 11:59 pm | Software documentation and testing | [Task 1], [Task 2], [Task 3], [Task 4], [Task 5], [Task 7] |
| 12/02/2025 at 11:59 pm | Software changes and software testing | [Task 6], [Task 7] |
| 12/09/2025 at 11:59 pm | Revision of the software documentation and software testing | [Task 1], [Task 2], [Task 3], [Task 4], [Task 5], [Task 6], [Task 7] |
...
AI Usage Level 2 - Some AI Allowed, see details after task description
...
AI Usage Level 2 - Some AI Allowed
* You may
  * Use AI to help generate your UML (without restrictions on the tools you use or how you use them) 
* But you must
    * (Preferred) Provide a description inside <dir>/app/doc/overview.html that would explain to a developer how you got the results (e.g. what tool(s) you used, how to prompt, what did you need to fix manually, etc.)
        * Alternatively, you may add your conversation/prompt logs to the <dir>/app/doc/diagrams folder
    * Respect decisions of not wanting AI involvement
* Note: You may also still continue AI usage from previous iteration around Mermaid, which does not have citation/reflection requirements.
...
AI Usage Level 2 - Some AI Allowed
* You may
  * Let AI generate Javadoc comments for code you have written yourself or code written by teammates who have given you explicit permission to do so. (Should be part of the Team_PE)
* But you must
  * Indicate that you have verified the accuracy of the generated Javadoc 
   * At end of description portion of Javadoc (before tags) - “Generated by <AI source>, verified by <your name>.” where you put in the AI source and your name.
  * Fix its mistakes (including being technically correct but overly verbose and/or including irrelevant details)
  * Respect decisions of not wanting AI involvement
