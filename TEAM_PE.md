...
* We will divide the tasks into categories based on the type of task they are, i.e. software changes, documentation, tests, etc. Then, we will assign the tasks to spread out the work and time demands as evenly as possible. For longer tasks and important documentation like UMLs, multiple group members will collaborate to ensure progess is being made. If team members need help with their tasks, they can reach out to others for assistance and everyone can contribute ideas and solutions to any possible problems.
...
* Everyone should respond to communications from other team members in a timely manner, and make it known if they will be unavailable to contact for a period of time
* Attend class/lab when needed/as requested by other teammates
* Contribute regularly based on the tasks you are assigned and the expected timeline provided for each project iteration
* Be respectful and calm when running into issues with the project, teammates, or any other difficulties
